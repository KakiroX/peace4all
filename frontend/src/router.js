...
const routes = [
	...
	},
	{
		path: '/courses',
		name: 'Courses',
		redirect: { name: 'CourseDetail', params: { courseName: 'positive-peace' } },
	},
	{
...
router.beforeEach(async (to, from, next) => {
	...
	if (!isLoggedIn) {
		if (to.name == 'Home') router.push({ name: 'CourseDetail', params: { courseName: 'positive-peace' } })
